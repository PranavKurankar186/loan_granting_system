...
const LoanOfficerLoanRequest = () => {
    ...
    useEffect(()=>{
        ...
        axios.get(`http://localhost:8080/loanofficer/loan_requests/${window.localStorage.getItem("user_id")}`).then((response) =>{
...
export default LoanOfficerLoanRequest