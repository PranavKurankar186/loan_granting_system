...
const  ViewBussinessCredit = () => {
  ...
  return (
    ...
    <AdminNav></AdminNav>
            ...
            {showPicFlag && <div><img src={`http://localhost:8080/admin/getBussinessCredit/${loanId}`} alt="Not Found" /></div>}
        </div>
  )
}

export default ViewBussinessCredit