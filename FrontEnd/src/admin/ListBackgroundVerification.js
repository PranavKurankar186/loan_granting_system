...
const ListBackgroundVerification = () => {
...
const navigate=useNavigate();
    ...
    useEffect(()=>{
        axios.get(`http://localhost:8080/admin/listbgvfo`).then((response) =>{
  ...
  return (
    <div>
      <AdminNav></AdminNav>
         <h2 className="mb-4 ms-3 mt-3">Background Verification List</h2>
...
export default ListBackgroundVerification